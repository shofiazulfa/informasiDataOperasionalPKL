@extends('layouts.app', ['title' => 'Create Operasional Lain - Admin'])
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h4 class="mt-4 mb-4">Create Operasional Lain</h4>
                    <form action="{{ route('master.pengeluaran.store') }}" class="row g-3" method="POST">
                        @csrf
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="kredit_view" placeholder="Masukkan kredit">
