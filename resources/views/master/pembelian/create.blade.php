@extends('layouts.app', ['title' => 'Create Pembelian - Admin'])
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h4 class="mt-4 mb-4">Create Pembelian</h4>
                    <form action="{{ route('master.pembelian.store') }}" class="row g-3" method="POST">
                        @csrf
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="pcs_view" placeholder="Masukkan satuan barang">

                            <input type="hidden" name="pcs" id="pcs">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" disabled id="total_jumlah_view"
                                placeholder="Data akan terinput otomatis bila form satuan barang dan harga satuan diisi">
